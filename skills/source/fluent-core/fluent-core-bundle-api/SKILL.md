...
description: >
  ...
  Keywords: FluentBundle, FluentResource, addResource, formatPattern,
  getMessage, custom functions, FluentType, get translation, format message,
  load translations, use Fluent API.
license: MIT
